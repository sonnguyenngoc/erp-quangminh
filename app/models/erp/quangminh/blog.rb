module Erp::Quangminh
  class Blog < ApplicationRecord
		mount_uploader :image_url, Erp::Quangminh::BlogUploader
		
    belongs_to :creator, class_name: "Erp::User"
    belongs_to :blog_category, class_name: "Erp::Quangminh::BlogCategory"
    ...
    def self.get_blogs(params)
			query = self.all
			query = query.order('erp_quangminh_blogs.created_at DESC')
    end
