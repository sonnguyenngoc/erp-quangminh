module Erp::Quangminh
  class ProductBrand < ApplicationRecord
		mount_uploader :image_url, Erp::Quangminh::ProductBrandUploader
    ...
    def self.dataselect(keyword='')
      ...
      query = query.limit(20).map{|product_brand| {value: product_brand.id, text: product_brand.name} }
    end
    
    def self.get_product_brands
